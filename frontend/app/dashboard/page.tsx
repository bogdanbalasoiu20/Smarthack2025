...
/**
 * Sidebar: Meniul lateral de navigare (MODIFICAT)
 */
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        {userRole === "ELEV" && (
          <>
            ...
            />
            {/* "Notele Mele" și "Catalog Cursuri" au fost eliminate */}
          </>
        )}
...
/**
 * Navbar: Bara de sus a conținutului principal (MODIFICAT)
 */
const Navbar = ({
  onMenuClick,
  userName,
        ...
        <div className="hidden md:block">
          <div className="relative">
            ...
            <input
              ...
              value={searchTerm} // Controlăm valoarea
              onChange={(e) => onSearchChange(e.target.value)} // Trimitem schimbarea
              className="
...
// --- LAYOUT PRINCIPAL ---
/**
 * DashboardLayout: Container-ul care deține Sidebar și Navbar (MODIFICAT)
 */
...
/**
 * ElevDashboard: Conținutul pentru rolul ELEV (MODIFICAT)
 */
const ElevDashboard = ({ userName, searchTerm }) => {
  const [courses, setCourses] = useState(initialElevCourses);

  // --- NOU --- Filtrează cursurile pe baza searchTerm
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.length > 0 ? (
              // --- MODIFICAT --- Folosește filteredCourses
...
/**
 * ProfesorDashboard: Conținutul pentru rolul PROFESOR (MODIFICAT)
 */
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.length > 0 ? (
              ...
              <p className="text-gray-500 dark:text-gray-400 md:col-span-2 lg:col-span-3">
                {searchTerm
                  ? "Niciun curs găsit."
                  : 'Nu ați creat încă niciun curs. Apăsați pe "Creează Curs Nou" pentru a începe.'}
              </p>
            )}
          </div>
        </div>
...
/**
 * AdminDashboard: Conținutul pentru rolul ADMIN (MODIFICAT)
 */
...
export default function DashboardPage() {
  ...
  // --- NOU --- Stare pentru bara de căutare
  ...
  const renderDashboardContent = () => {
    switch (userRole) {
      case "ELEV":
        // --- MODIFICAT --- Trimite searchTerm
        return <ElevDashboard userName={userName} searchTerm={searchTerm} />;
      case "PROFESOR":
        // --- MODIFICAT --- Trimite searchTerm
        return <ProfesorDashboard userName={userName} searchTerm={searchTerm} />;
      case "ADMIN":
        // --- MODIFICAT --- Trimite searchTerm
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-950">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* --- MODIFICAT --- Trimite searchTerm și handler-ul */}
        <DashboardLayout
          userRole={userRole}
          userName={userName}
